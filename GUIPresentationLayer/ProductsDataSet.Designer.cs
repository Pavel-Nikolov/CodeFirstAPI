...
namespace GUIPresentationLayer {
    ...
    public partial class ProductsDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string Barcode, string Name, decimal Price, int Quantity, int Brand_ID) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow FindByBarcode(string Barcode) {
...
namespace GUIPresentationLayer.ProductsDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([Barcode] = @Original_Barcode) AND ([Name] =" +
                " @Original_Name) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Qua" +
                "ntity) AND ([Brand_ID] = @Original_Brand_ID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Barcode], [Name], [Price], [Quantity], [Brand_ID])" +
                " VALUES (@Barcode, @Name, @Price, @Quantity, @Brand_ID);\r\nSELECT Barcode, Name, " +
                "Price, Quantity, Brand_ID FROM Products WHERE (Barcode = @Barcode)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Barcode] = @Barcode, [Name] = @Name, [Price] = @Price, [Quantity] = @Quantity, [Brand_ID] = @Brand_ID WHERE (([Barcode] = @Original_Barcode) AND ([Name] = @Original_Name) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity) AND ([Brand_ID] = @Original_Brand_ID));
SELECT Barcode, Name, Price, Quantity, Brand_ID FROM Products WHERE (Barcode = @Barcode)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GUIPresentationLayer.Properties.Settings.Default.CodeFirstAPIConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Barcode, Name, Price, Quantity, Brand_ID FROM dbo.Products";
        ...
        public virtual int Delete(string Original_Barcode, string Original_Name, decimal Original_Price, int Original_Quantity, int Original_Brand_ID) {
        ...
        public virtual int Insert(string Barcode, string Name, decimal Price, int Quantity, int Brand_ID) {
            if ((Barcode == null)) {
        ...
        public virtual int Update(string Barcode, string Name, decimal Price, int Quantity, int Brand_ID, string Original_Barcode, string Original_Name, decimal Original_Price, int Original_Quantity, int Original_Brand_ID) {
            if ((Barcode == null)) {
                throw new global::System.ArgumentNullException("Barcode");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_Brand_ID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, decimal Price, int Quantity, int Brand_ID, string Original_Barcode, string Original_Name, decimal Original_Price, int Original_Quantity, int Original_Brand_ID) {
            return this.Update(Original_Barcode, Name, Price, Quantity, Brand_ID, Original_Barcode, Original_Name, Original_Price, Original_Quantity, Original_Brand_ID);
        }
    }
